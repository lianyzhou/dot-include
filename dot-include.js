/*
doT Express which support partials
@author Lianyzhou <zhoulianyi@antrol.com>
@license http://opensource.org/licenses/MIT
*/


(function() {
  var Defines, clone, curOptions, curPath, defaults, doT, e, fs, mergeObjects, path, renderFile, workingPaths;
